                ...
                <div className='grid grid-cols-1  gap-10'>
                    ...
                    <div className='flex flex-col gap-4 font-bold'>
                        ...
                        <motion.div className='text-xs md:text-sm font-normal text-justify flex flex-col gap-2'
                            ...
                            <p>I am a third-year computer engineering student at Kasetsart University with a strong passion for software development. I have built several projects, including both frontend and backend applications using programming languages and frameworks such as Go, Node.js, React, and others. I believe that intelligence can be developed through dedication and hard work, and I am excited to apply my skills and knowledge to develop innovative and user-friendly software products.</p>
                        </motion.div>
